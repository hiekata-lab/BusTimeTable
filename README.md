# 東京大学柏Iキャンパス バス時刻表 / UTokyo Kashiwa I Campus Bus Time Table

## 1. 概要 / Overview

これは東京大学柏Iキャンパス周辺の次発のバスを表示する Web アプリケーションです。稗方研 FY2024 卒業の Shuhei Tanaka さんが作ったものをもとにしています。このリポジトリは MIT License です。研究室内外を問わず、自由に使って／コピーして／変更して／再配布していただいて構いません。
